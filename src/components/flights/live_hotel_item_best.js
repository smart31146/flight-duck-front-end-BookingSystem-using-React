...
const LiveHotelItemBest = (hotelDetails) => {
  ...
  return (
    <div className="single-destinations-list style-three best" style={{ position: 'relative' }}>
      <span style={{ position: 'absolute', background: "#04c50d", color: "white", padding: "4px 8px", top: "-36px", "borderRadius": "4px" }}>Best Deal</span>
      <div className="thumb">
        {hotelImage()}
      </div>
...
export default LiveHotelItemBest